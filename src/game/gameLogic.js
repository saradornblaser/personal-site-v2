...
// Wrap everything in a function to defer execution until DOM is ready.
// This is an old game, just adding it to the new site.
export function startGame() {

const {canvas, spriteSheet, ctx} = getDomObjects();
